...
import { isLoggedIn, removedSession } from "../../util/helpers/sessions";

export default function Header({
  headerTitle = "Reebok Store",
  headerText = "Welcome to the reebook store",
  activePage = "home",
}) {
    ...
    <header>
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary py-3">
        <div class="container-fluid">
          ...
          <div
            class={`collapse navbar-collapse text-center ${showMenu && "show"}`}
          >
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto my-0">
              ...
              {isLoggedIn() ? (
                ...
                <li class="nav-item">
                  <Link
                    class={`nav-link ${activePage === "my-account" && "active"}`}
                    to="/my-account"
                  >
                    My-Account
                  </Link>
                ...
                <>
                  ...
                  <li class="nav-item">
                    <Link
                      class={`nav-link ${activePage === "signup" && "active"}`}
                      to="/sign-up"
                    >
                      Sign Up
                    </Link>
